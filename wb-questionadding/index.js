...
$(document).ready(function () {
    ...
    $('.next').click(function () {
        switch (page) {
            case 1:
                ...
                if (gName != '') {
                    data.GName = gName;
                    $('.questionadding1,.questionadding3,.questionadding5').css("display", "none");
            ...
            case 2:
                ...
                if (data.Question.length > 0) {
                    ...
                    if (checkStatus == 0) {
                        ...
                        $('#Q2-alert').hide();
                        $('.questionadding1,.questionadding2,.questionadding5').css("display", "none");
                        ...
                        success: function (res) {
                            ...
                            $.ajax({
                                ...
                                success: function (response) {
                                    ...
                                    let gn = $(".questionadding1 input").val();
                                    // console.log(gn);
                                    $('.questionadding5 label').text(gn);
            ...
            //     break;
            default:
                window.location = "/ChoicePie/wb-question";
                break;
        }
    });
    ...
    $('.back').click(function () {
        ...
        switch (page) {
            case 1:
                $('.questionadding2,.questionadding3,.questionadding5').css("display", "none");
            ...
            //     break;
            case 4:
                $('.questionadding1,.questionadding2,.questionadding3').css("display", "none");
                $('.questionadding5').css("display", "block");
