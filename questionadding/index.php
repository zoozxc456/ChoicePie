...
<body>
    ...
    <div id="content" class="row m-0 p-0 container-fluid">
        ...
        <div id="article" class="col-lg-8 col-md-10 col-sm-12 p-0 ">
            <!-- questionadding-1 -->
            <?php require_once '../questionadding-1/index.php'; ?>
            <!-- questionadding-2 -->
            <?php require_once '../questionadding-2/index.php'; ?>
            <!-- questionadding-3 -->
            <?php require_once '../questionadding-3/index.php'; ?>
            <!-- questionadding-4 -->
            <?php require_once '../questionadding-4/index.php'; ?>
            <!-- questionadding-5 -->
            <?php require_once '../questionadding-5/index.php'; ?>
